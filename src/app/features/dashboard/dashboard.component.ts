...
@Component({
  ...
  template: `
    <div class="dashboard-root">
      <header class="dashboard-header">
        ...
        <p>Resumen de actividades {{ today | date:'mediumDate' }}</p>
      </header>
      ...
      <div class="metrics-grid">
        <mat-card class="metric-card primary">
          <mat-card-header>
            ...
            <mat-card-subtitle>Total Documentos</mat-card-subtitle>
          </mat-card-header>
        </mat-card>
        ...
        <mat-card class="metric-card warning">
          <mat-card-header>
            ...
            <mat-card-subtitle>Pendientes de Firma</mat-card-subtitle>
          </mat-card-header>
        </mat-card>
        ...
        <mat-card class="metric-card success">
          <mat-card-header>
            ...
            <mat-card-subtitle>Completados</mat-card-subtitle>
          </mat-card-header>
        </mat-card>
      ...
      <div class="dashboard-sections">
        ...
        <aside class="quick-actions">
          ...
          <div class="actions-grid">
            <button mat-flat-button color="primary" routerLink="/documents/upload" *ngIf="isAdmin()">
              <mat-icon>add</mat-icon> SUBIR ACTA
            </button>
  ...
  `,
  styles: [`
    .dashboard-root { display: flex; flex-direction: column; gap: 40px; }
    .dashboard-header h1 { font-size: 36px; font-weight: 900; margin-bottom: 4px; color: var(--accent-color); }
    .dashboard-header p { color: var(--text-muted); font-size: 15px; font-weight: 500; }
    ...
    .metric-card mat-card-title { font-size: 36px !important; font-weight: 900 !important; margin-bottom: 2px; color: var(--accent-color); }
    .metric-card mat-card-subtitle { font-size: 11px; text-transform: uppercase; letter-spacing: 1px; font-weight: 700; color: var(--text-muted); }
    .metric-card mat-icon { font-size: 36px; width: 36px; height: 36px; }
    
    .primary mat-icon { color: var(--primary-color); }
    .warning mat-icon { color: #f59e0b; }
    .success mat-icon { color: #10b981; }
    .accent mat-icon { color: var(--secondary-color); }
    ...
    .section-header h3 { font-size: 20px; font-weight: 800; color: var(--accent-color); margin: 0; }
    .activity-section { padding: 40px; }
    ...
    .quick-actions h3 { font-size: 18px; font-weight: 800; color: var(--accent-color); margin-bottom: 24px; }
    ...
    .outline-btn { border: 1px solid var(--border-color) !important; background: white !important; color: var(--text-color) !important; }
